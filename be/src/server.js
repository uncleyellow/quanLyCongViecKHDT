...
// Swagger Documentation - Note: This path might need adjustment for Vercel
// You might want a separate build step for Swagger UI or host it elsewhere
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(specs))
...
// Vercel sẽ tự động xử lý việc lắng nghe các request đến app này.
// Loại bỏ phần app.listen()
export default app